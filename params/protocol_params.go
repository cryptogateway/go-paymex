...
const (
	...
	CallNewAccountGas     uint64 = 15000 // Paid for CALL when the destination address didn't exist prior. * edit
	TxGas                 uint64 = 11000 // Per transaction not creating a contract. NOTE: Not payable on data of calls between transactions. * edit
	TxGasContractCreation uint64 = 33000 // Per transaction that creates a contract. NOTE: Not payable on data of calls between transactions. * edit
