...
import (
	...
	"github.com/cryptogateway/go-paymex/crypto/signify"
	"github.com/cryptogateway/go-paymex/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/cryptogateway/go-paymex/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/cryptogateway/go-paymex/mobile")
